            ...
            .exec(function(err,match){
                if (err) {
                    ...
                    if(match){
                        ...
                        if(typeof match.team_1.toss !='undefined' || typeof match.team_2.toss!='undefined'){
                          if(match.team_1.toss || match.team_2.toss){
                            ...
                            if(match.scoreupdate=='auto'){
                              ...
                              response.innings.current = match.innings.current;
                            }
                          }
                          else{
                        ...
                        if(response.match.scoreupdate == 'auto'){
                          ...
                          response.match.team_1.scorecard = response.match.team_1.scorecard;
                          response.match.team_2.scorecard = response.match.team_2.scorecard;
                          response.match.team_1.bowler_scorecard = response.match.team_1.bowler_scorecard;
                          response.match.team_1.bowler_scorecard = response.match.team_1.bowler_scorecard;
                        ...
                        getscores(req,res,response.match,data,scoreoptions,function(req,res,err,scores){
                            if (err) {
                               ...
                               if(typeof results.event.thirdumpire=='undefined'){
                                  results.event.thirdumpire = 0;
                               }

                               if(typeof results.event.ballchalu=='undefined'){
                                  results.event.ballchalu = 0;
                               }

                               if(typeof results.event.misfield=='undefined'){
                                  results.event.misfield = 0;
                               }

                               if(typeof results.event.injury=='undefined'){
                                  results.event.injury = 0;
                               }
                                  ...
                                  if (!err) {
                                    ...
                                    if(type == 'http'){
                                      ...
                                      if(typeof req.app!="undefined"){
                                        ...
                                        pushnotificationservice.pushmatchresult({
                                          matchdetails:response.match
                                        },function(){});

                                        pushnotificationservice.pushwicket({
                                          matchdetails:response.match
                                        },function(){
