module.exports = {
	matches:function(Mongoose,callback){

	
	var request = require('request');
    var utils = require("../services/utils");

    var teams = require("../models/activeteams").getModel(Mongoose);
    var tour = require("../models/tournaments").getModel(Mongoose);
    var match = require("../models/matchlists").getModel(Mongoose);
    var scoresauto = require("../models/scoresauto").getModel(Mongoose);
    var scores = require("../models/scores").getModel(Mongoose);
    var Commentaries = require("../models/commentary").getModel(Mongoose);
		...
		var FEEDS_URL = "http://static.cricinfo.com/rss/livescores.xml";
    		...
    		function getscorecarddetails(scores){
    			if(scores.length>0){
                    ...
                    // console.log("inside getmatch");
    				//Score Card Details
    				request(currentscore.link[0], function (scoreerror, scoreresponse, scorebody) {
    					if(!scoreerror){
    						const $ = cheerio.load(scorebody);
    						// console.log("header text",$('.game-details.header').text());
    						// console.log("header",$('.game-details.header'));
                           ...
                           try{
                            ...
                            matchdetails.match_view_status = "inactive";
                            ...
                            if(utils.isvalidData(tournamentdetails.name) && utils.isvalidData(team1details.team_name) 
                                ...
                                //console.log(team1details.team_name+" vs "+team2details.team_name);
                                //console.log(matchdetails.auto_match_id);
                                ...
                                tour.findOneAndUpdate({ tournament_name: tournamentdetails.name},{
                                    ...
                                    if(!err){
                                        ...
                                        teams.findOneAndUpdate({ team_name: team1details.team_name}, team1details, { upsert: true, new: true }, function (err, team1res) {
                                            ...
                                            if(team1res.autofetch == 'on'){
                                                matchdetails.match_view_status = "active";
                                            }
	...
	scores:function(Mongoose,callback){
		var request = require('request');
    	var utils = require("../services/utils");
	    ...
	    var match = require("../models/matchlists").getModel(Mongoose);
	    var scoresauto = require("../models/scoresauto").getModel(Mongoose);
	    var scores = require("../models/scoresauto").getModel(Mongoose);
	    var Commentaries = require("../models/commentary").getModel(Mongoose);
	    var Scorecarddetails = require('../lib/scorecarddetails');
            ...
            function updatescores(autogeneratedmatches){
               ...
               //console.log("match score - ",autogeneratedmatches.length);
                ...
                if(autogeneratedmatches.length>0){
                    ...
                    if(currentgeneratedmatches.team_1.teamid.autofetch == 'on' || currentgeneratedmatches.team_2.teamid.autofetch == 'on'){
                   ...
                   //console.log(currentgeneratedmatches.auto_match_id);
                    ...
                    request({
                        ...
                        $('.match-detail-container >.match-detail--item').each(function(i){
                            if($(this).find('.match-detail--left').text().toLowerCase() == 'toss'){
                                var toss_statement = $(this).find('.match-detail--right').text();
                        ...
                        currentgeneratedmatches.match_view_status = "active";
                       ...
                       //console.log(toss_statement);
                        ...
                        function setinnings(innings,team,currentgeneratedmatches){
                                if(innings == 0){
                                    ...
                                    currentgeneratedmatches.innings.current = 1;   
                                }
                                else if(innings == 1){
                                   // console.log("first",innings);
                                    ...
                                    currentgeneratedmatches.innings.current = 2;
                                }
                                else if(innings == 2){
                                    currentgeneratedmatches.innings.third = team;
                                    currentgeneratedmatches.innings.current = 3;
                                }
                                else if(innings == 3){
                                    currentgeneratedmatches.innings.fourth = team;
                                    currentgeneratedmatches.innings.current = 4;
                                }
                        }
                                ...
                                $(".sub-module.scorecard").each(function(i){
                                    ...
                                    if(currentteam.indexOf(team1details.team_name)>-1 || currentteam.indexOf(team1details.short_name)>-1 || currentteam.indexOf(team1details.alias)>-1){
                                       ...
                                       try{
                                        ...
                                        //Batting Scorecard
                                         $(this).find(".flex-row>.wrap.batsmen").each(function(){
                                            ...
                                            if(matchsegment == "M"){
                                                ...
                                                if(typeof $(this).find(".cell.runs").eq(5).text() !="undefined"){

                                                    batsmanscorecard1.strike_rate = $(this).find(".cell.runs").eq(5).text().replace('-','');
                                                    
                                                }
                                                //console.log("SPOT 1");
                                                //console.log(batsmanscorecard1.strike_rate);
                                            }
                                            else{
                                                ...
                                                if(typeof $(this).find(".cell.runs").eq(4).text() !="undefined"){
                                                    batsmanscorecard1.strike_rate = $(this).find(".cell.runs").eq(4).text().replace('-','');
                                                }
                                                //console.log("SPOT 2");
                                                //console.log(batsmanscorecard1.strike_rate);
                                            }
                                        ...
                                        try{
                                            //Bowling Scorecard
                                            $(this).find(".scorecard-section.bowling tbody tr").each(function(data, element){
                                           ...
                                           // console.log("Team 2 scorecard start");
                                            ...
                                            setinnings(i,"team2",currentgeneratedmatches);
                                                ...
                                                if(matchsegment == "M"){
                                                    ...
                                                    if(typeof $(this).find(".cell.runs").eq(5).text() !="undefined"){
                                                        batsmanscorecard2.strike_rate = $(this).find(".cell.runs").eq(5).text().replace('-','');;
                                                    }
                                                    //console.log("SPOT 3");
                                                    //console.log(batsmanscorecard1.strike_rate);
                                                    ...
                                                    if(typeof $(this).find(".cell.runs").eq(4).text() !="undefined"){
                                                        batsmanscorecard2.strike_rate = $(this).find(".cell.runs").eq(4).text().replace('-','');
                                                    }
                                                    //console.log("SPOT 4");
                                                    //console.log(batsmanscorecard1.strike_rate);
                                                }
                                                    ...
                                                    $(this).find('tr').each(function(){
                                                        ...
                                                        if(activebatsman.indexOf('*')>-1){
                                                            ...
                                                            scoredetails.active_batsman = {
                                                                ...
                                                                strike_rate:$(this).find('td').eq(5).text().replace('-',''),
                                                                age: 0,
                                                                type:""
                                                            }
                                                            //console.log("SPOT 5");
                                                            //console.log(scoredetails.active_batsman);
                                                        ...
                                                        //console.log("SPOT 6");
                                                        //console.log($(this).find('td').eq(5).text().replace('-',''));
                                                    })
                                                })
                                            }
                                            catch(e){
                                            ...
                                            try{
                                                ...
                                                $(this).find('tr').each(function(){
                                                        ...
                                                        if(activebatsman.indexOf('*')>-1){
                                                            ...
                                                            //console.log("SPOT 7");
                                                            //console.log(scoredetails.active_batsman.strike_rate);

                                                            if(typeof scoredetails.active_batsman.strike_rate!="undefined"){
                                                                scoredetails.active_batsman.strike_rate.replace('-','');
                                                            }
                                                        }
...
request({url:"http://localhost:8000/api/v1/pushdata", qs:{"match_id":currentgeneratedmatches._id}}, function(err, response, body) {
